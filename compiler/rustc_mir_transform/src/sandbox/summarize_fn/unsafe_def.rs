...
fn find_unsafe_fn_def(body: &'tcx Body<'tcx>,
...
fn find_unsafe_def_core(place_locals: &mut FxHashSet<Local>,
                        bb: BasicBlock,
...
fn find_unsafe_def(body: &Body<'tcx>, results: &mut FxHashSet<DefSite>) {
